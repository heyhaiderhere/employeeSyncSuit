            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                <div class="navbar-header pt-3">
                    <a class="navbar-brand d-flex" href="<?php echo base_url(); ?>">
                        <img style="height: 50px; width: 50px" src="<?php echo base_url();?>assets/images/logo-icon.png"
                            alt="DRI" class="DRI-logo" style="width:50px;" />
                        <p style="title-name" style="font-size: 16px !important;"> Employee Sync Suite </p>
                        <!-- Light Logo text -->
                    </a>
                </div>
                                        ...
                                        <div class="message-center">
                                            ...
                                            <a href="#">
                                                ...
                                                <div class="mail-contnet">
                                                    <h5><?php echo $value->first_name; ?></h5> <span
                                                        class="mail-desc"><?php echo $value->reason; ?></span> <span
                                                        class="time"><?php echo $value->start_date; ?></span>
                                                </div>
                                            </a>
                                            <?php endforeach; ?>
                                        </div>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="#"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                                    ...
                                    alt="Genit" class="profile-pic"
                                    style="height:40px;width:40px;border-radius:50px" /></a>
                            <div class="dropdown-menu dropdown-menu-right scale-up">
                                <ul class="dropdown-user">
                                    ...
                                    <li><a href="<?php echo base_url(); ?>settings/Settings"><i class="ti-settings"></i>
